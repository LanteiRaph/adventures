<template>
    ...
    <div class="left_panel">
      <div class="card" v-for="(value) in values" :key="value.id">
        <span class="card-header">
          <img :src="require(`../assets/hotel/${value.img}`)" />
        ...
        <span class="card-meta">
          ...
          <button type="submit" v-on:click="hireCar(value.id)">Select</button>
        </span>
      </div>
    </div>
    ...
    <div class="right_panel">
      <div class="top">
        {{Flow.description}}
        <p>You Can Hire one or more cars</p>
      </div>
      <div class="bottom">
        <p>Press Next To move to the next step</p>
        <button v-on:click='manage()'> Next </button>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    hireCar (carid) {
      ...
      //
      // Push the car to the responce value.
      this.responceValue.push(car)
    },
    manage () {
    //
